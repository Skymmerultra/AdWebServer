...
public class GraphController {
    ...
    public Result<List<GraphVo>> getGraphByTypeAndId(@PathVariable("itemType")Integer itemType,@PathVariable("itemId")Long itemId) {
        List<GraphVo> result = graphService.getGraphListByTypeAndId(itemType, itemId);
